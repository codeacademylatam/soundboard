...
sounds = {
    "Créditos": pygame.mixer.Sound(resource_path("sounds/directed-by-robert-b-weide.mp3")),
    "Error": pygame.mixer.Sound(resource_path("sounds/error.mp3")),
    "Exclamation": pygame.mixer.Sound(resource_path("sounds/exclamation (metal gear).mp3")),
    ...
    "Momento cultural": pygame.mixer.Sound(resource_path("sounds/vivaldi.mp3")),
    "X-Files": pygame.mixer.Sound(resource_path("sounds/x-files.mp3")),
}
...
images = {
    ...
    "Momento cultural": pygame.image.load(resource_path("images/vivaldi.png")),
    "X-Files": pygame.image.load(resource_path("images/x-files.png")),
}
